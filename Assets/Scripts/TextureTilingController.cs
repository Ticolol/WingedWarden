...
public class TextureTilingController : MonoBehaviour {
	...
	void UpdateTiling()
	{
		...
		gameObject.GetComponent<Renderer>().material.mainTextureScale = new Vector2(planeSizeX*gameObject.transform.lossyScale.x/textureToMeshX, planeSizeZ*gameObject.transform.lossyScale.y/textureToMeshZ);
	}
}